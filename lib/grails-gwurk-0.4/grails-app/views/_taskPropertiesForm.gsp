controller: <g:textField name="${prefix?"props.${prefix}.":''}controller" value="${fieldValue(bean:props,field:'controller')}"/><br />
action: <g:textField name="${prefix?"props.${prefix}.":''}action" value="${fieldValue(bean:props,field:'action')}"/><br />
rewardAmount:<g:textField name="${prefix?"props.${prefix}.":''}rewardAmount" value="${props?.rewardAmount?fieldValue(bean:props,field:'rewardAmount'):""}"/><br />
batchSize:<g:textField name="${prefix?"props.${prefix}.":''}batchSize" value="${props?.batchSize?fieldValue(bean:props,field:'batchSize'):""}"/><br />
relaunchInterval:<g:textField name="${prefix?"props.${prefix}.":''}relaunchInterval" value="${props?.relaunchInterval?fieldValue(bean:props,field:'relaunchInterval'):""}"/><br />
autoApprove:<g:textField name="${prefix?"props.${prefix}.":''}autoApprove" value="${props?.autoApprove?fieldValue(bean:props,field:'autoApprove'):""}"/><br />
